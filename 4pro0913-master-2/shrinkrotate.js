	...
	*/
	...
	shrunken:function(){
		...
		for(let v of this.men[f]){
		    ...
		    let x=(Math.cos(Math.PI*this.theta/180))*dx-(Math.sin(Math.PI*this.theta/180))*dy+mcx;
		    let y=(Math.sin(Math.PI*this.theta/180))*dx+(Math.cos(Math.PI*this.theta/180))*dy+mcy;
		    pstr += (x+" "+y+" ");
